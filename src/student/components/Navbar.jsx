  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full px-2 sm:px-4 md:px-6 lg:px-8 bg-white">
      <div className="w-full max-w-7xl mx-auto">
        <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 shadow-gray-800 rounded-lg sm:rounded-xl shadow-md bg-white h-16 sm:h-18 md:h-20">
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden pb-4 border-t border-gray-200 pt-4 px-3 sm:px-4 md:px-6 bg-white rounded-b-lg shadow-md">
